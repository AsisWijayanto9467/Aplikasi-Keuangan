...
class _StatisticsPageState extends State<StatisticsPage>
  ...
  Widget _buildSummaryCards() {
    final totalIncome = _summary['total_income'] ?? 0.0;
    final totalExpense = _summary['total_expense'] ?? 0.0;
    final netCashflow = _summary['net_cashflow'] ?? 0.0;
    final incomePercentage = _summary['income_percentage'] ?? 0.0;
    final expensePercentage = _summary['expense_percentage'] ?? 0.0;
  ...
  List<BarChartGroupData> _buildBarGroups() {
    return List.generate(_trendData.length, (index) {
      ...
      final income = (data['income'] ?? 0.0).toDouble();
      final expense = (data['expense'] ?? 0.0).toDouble();
  ...
  double _getMaxBarValue() {
    if (_trendData.isEmpty) return 100000;
    ...
    final magnitude = (maxValue / 100000).ceil() * 100000;
